package com.dhcc.xml.parse.dao;
...
public interface BatchItemDao {
	...
	public String selectEbCustBaseInfo(String record_id,String filename);//企业基本信息310
		 ...
		 * @return
		 */
		public String selectPbCustBaseInfo(Map<String,String> map);//个人基本信息110
		public void updatePbCustBaseInfo(Map<String,String> map);//反馈报文有错误时修改在原来表中的修改状态110
		public void updatePbCustBaseInfoh(Map<String,String> map);//反馈报文有错误时修改历史表在原来表中的修改状态110
