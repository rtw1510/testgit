 ...
 * 处理类。
 */
@Component("IncomeAndExpenseStatementDltProcessor")
@StepScope
public class IncomeAndExpenseStatementDltProcessor implements ItemProcessor<IncomeAndExpenseStatementDlt, Object> {
	...
	public Object process(IncomeAndExpenseStatementDlt incomeAndExpenseStatementDlt) throws Exception {
		EntDocument entDocument = new EntDocument();
		entDocument.setIncomeAndExpenseStatementDlt(incomeAndExpenseStatementDlt);
