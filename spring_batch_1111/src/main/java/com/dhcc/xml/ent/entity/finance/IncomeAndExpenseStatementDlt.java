...
/**
 * Title: IncomeAndExpenseStatementDlt<br/>
 * Description:事业单位收入支出表整笔删除请求记录数据项<br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
...
// 指定序列成的xml节点顺序
public class IncomeAndExpenseStatementDlt {
	/**
	 *信息记录类型
	 */
	...
	public IncomeAndExpenseStatementDlt() {
		super();
	...
	public String toString() {
		return "InstitutionBalanceSheetDlt [" + "InfRecType=" + InfRecType
				+ "EntName=" + EntName + "EntCertType=" + EntCertType
				+ "EntCertNum=" + EntCertNum + "SheetYear=" + SheetYear + "SheetType=" + SheetType
				+ "SheetTypeDivide" + SheetTypeDivide + "]";
	}
}
