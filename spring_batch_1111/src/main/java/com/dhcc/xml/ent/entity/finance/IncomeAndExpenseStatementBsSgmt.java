...
/**
 * Title: IncomeAndExpenseStatementBsSgmt<br/>
 * Description:事业单位收入支出表信息记录基础段<br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
...
// 指定序列成的xml节点顺序
public class IncomeAndExpenseStatementBsSgmt {
	/**
	 *信息记录类型
	 */
	...
	public IncomeAndExpenseStatementBsSgmt() {
		super();
	}
