...
/**
 * Title: EB_FinaCsh07_Info<br/>
 * Description:数据库映射：基础段+2007版现金流量表段 <br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
public class EB_FinaCsh07_Info {
	/**
	 *信息记录类型
	 */
	 ...
	 * 
	 * @param netCashInflowsOfDisposalOfSubsidiariesAndOtherBusinessEntities
	 *            处置子公司及其他营业单位收到的现金净额
	 */
	 ...
	 * 
	 * @param netCashOutflowsOfProcurementOfSubsidiariesAndOtherBusinessUnits
	 *            取得子公司及其他营业单位支付的现金净额
	 */
	 ...
	 * 
	 * @return the subTotalOfCashOutflows 投资活动现金 流出小计
	 */
	 ...
	 * 
	 * @param initialCashAndCashEquivalentsBalance
	 *            期初现金及现金等价物余额
	 */
	 ...
	 * 
	 * @param theFinalCashAndCashEquivalentsBalance
	 *            期末现金及现金等价物余额
	 */
	 ...
	 * 
	 * @param amortisationOfLongTermDefferedExpenses
	 *            长期待摊费用摊销
	 */
	 ...
	 * 
	 * @param profitOrLossFromChangesInFairValue
	 *            公允价值变动损失
	 */
	 ...
	 * 
	 * @param cashEquivalentsAtTheBeginningOfThePeriod
	 *            现金等价物的期初余额
	 */
