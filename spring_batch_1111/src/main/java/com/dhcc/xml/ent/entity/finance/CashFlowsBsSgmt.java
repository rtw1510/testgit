...
/**
 * Title: CashFlowsBsSgmt<br/>
 * Description:企业现金流量表信息记录基础段<br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
...
public class CashFlowsBsSgmt {
	...
	public String toString() {
		return "CashFlowsBsSgmt [" + "InfRecType =" + InfRecType + "EntName ="
