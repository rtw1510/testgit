...
/**
 * Title: IncomeStatementProfitAppropriationBsSgmt<br/>
 * Description:企业资产负债表信息记录基础段<br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
...
// 指定序列成的xml节点顺序
public class IncomeStatementProfitAppropriationBsSgmt {
	/**
	 *信息记录类型
	 */
	...
	public IncomeStatementProfitAppropriationBsSgmt() {
		super();
	}
	...
	public String toString() {
		return "IncomeStatementProfitAppropriationBsSgmt [InfRecType="
				+ InfRecType + ", EntName=" + EntName + ", EntCertType="
				+ EntCertType + ", EntCertNum=" + EntCertNum + ", RptDate="
				+ RptDate + ", SheetYear=" + SheetYear + ", SheetType="
				+ SheetType + ", SheetTypeDivide=" + SheetTypeDivide
				+ ", AuditFirmName=" + AuditFirmName + ", AuditorName="
				+ AuditorName + ", AuditTime=" + AuditTime + ", Cimoc=" + Cimoc
				+ ", RptDateCode=" + RptDateCode + "]";
	}
