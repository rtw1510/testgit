...
/**
 * Title: IncomeStatementProfitAppropriationDlt<br/>
 * Description:企业利润及利润分配表整笔删除请求记录数据项 <br/>
 * 
 * @author ChenJingYuan
 * @date 2018年1月26日
 */
...
// 指定序列成的xml节点顺序
public class IncomeStatementProfitAppropriationDlt {
	/**
	 *信息记录类型
	 */
	...
	public IncomeStatementProfitAppropriationDlt() {
		super();
	...
	public String toString() {
		return "IncomeStatementProfitAppropriationDlt [" + "InfRecType="
				+ InfRecType + "EntName=" + EntName + "EntCertType="
				+ EntCertType + "EntCertNum=" + EntCertNum + "SheetYear=" + SheetYear + "SheetType=" + SheetType
				+ "SheetTypeDivide" + SheetTypeDivide + "]";
	}
