...
import com.dhcc.xml.ent.entity.loaninfo.BsSgmt;
...
import com.dhcc.xml.ent.entity.loaninfo.MdfcSgmt;
 ...
 * @date 2018年3月25日
 */
@Component("EnAcctInfMdfcProcessor")
@StepScope
public class EnAcctInfMdfcProcessor implements ItemProcessor<Eb_AcctMdf_Info, Object> {
	...
	public Object process(Eb_AcctMdf_Info eb_AcctMdf_Info) throws Exception {
		...
		enAcctInfMdfc = new EnAcctInfMdfc();
		bsSgmt = new BsSgmt();
		...
		enAcctInfMdfc.setBsSgmt(bsSgmt);
		if ("B".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			Eb_CorpAcct_Info eb_CorpAcct_Info = eb_AcctMdf_Info.getEb_CorpAcct_Info();
			if (eb_CorpAcct_Info != null&& CheckUtilPlus.checkStr(eb_CorpAcct_Info.getAcctCode())) {
		...
		if ("C".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			Eb_CorpAcct_Info eb_CorpAcct_Info = eb_AcctMdf_Info.getEb_CorpAcct_Info();
			if (eb_CorpAcct_Info != null&& CheckUtilPlus.checkStr(eb_CorpAcct_Info.getBusiLines())) {
		...
		if ("D".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			List<Eb_CorpAccRlt_Info> Eb_CorpAccRlt_Info_List = eb_AcctMdf_Info.getEb_CorpAccRlt_Info_List();
		...
		if ("F".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			Eb_CorpAcct_Info eb_CorpAcct_Info = eb_AcctMdf_Info.getEb_CorpAcct_Info();
			if (eb_CorpAcct_Info != null&& CheckUtilPlus.checkStr(eb_CorpAcct_Info.getMcc())) {
		...
		if ("G".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			Eb_CorpAcct_Info eb_CorpAcct_Info = eb_AcctMdf_Info.getEb_CorpAcct_Info();
			if (eb_CorpAcct_Info != null&& CheckUtilPlus.checkStr(eb_CorpAcct_Info.getInitCredName())) {
		...
		if ("H".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			Eb_CorpAccRetu_Info eb_CorpAccRetu_Info = eb_AcctMdf_Info.getEb_CorpAccRetu_Info();
			if (eb_CorpAccRetu_Info != null&& CheckUtilPlus.checkStr(eb_CorpAccRetu_Info.getAcctStatus())) {
				...
				actLbltyInfSgmt.setCloseDate(UpdateDate.updateDate(actLbltyInfSgmt.getCloseDate()));
				...
				if ("R1".equals(eb_AcctMdf_Info.getEb_CorpAcct_Info().getAcctType())) {
				...
				if (!"C1".equals(eb_AcctMdf_Info.getEb_CorpAcct_Info().getAcctType())) {
				...
				mdfcSgmt.setActLbltyInfSgmt(actLbltyInfSgmt);
			}
		}
		
		if ("I".equals(eb_AcctMdf_Info.getMdfcSgmtCode())) {
			List<Eb_CorpAccSpec_Info> Eb_CorpAccSpec_Info_List = eb_AcctMdf_Info.getEb_CorpAccSpec_Info_List();
			if (CheckUtilPlus.checkList(Eb_CorpAccSpec_Info_List)) {
				for (Eb_CorpAccSpec_Info eb_CorpAccSpec_Info : Eb_CorpAccSpec_Info_List) {
					if (CheckUtilPlus.checkStr(eb_CorpAccSpec_Info.getDetInfo())) {
		...
		enAcctInfMdfc.setMdfcSgmt(mdfcSgmt);
		entDocument.setEnAcctInfMdfc(enAcctInfMdfc);
