...
/**
 * Title: BsSgmt<br/>
 * Description: 个人担保账户按段更正请求记录基础段<br/>
 * 
 * @author ChenJingYuan
 * @date 2018年3月28日
 */
...
// 访问类型改为字段
@XmlType(propOrder = { "InfRecType", "ModRecCode", "RptDate","AcctType","MdfcSgmtCode"},namespace = "com.dhcc.xml.per.entity.guarantee")
// 指定序列成的xml节点顺序
public class BsSgmt {
	/**
	 * 信息记录类型 [1..1]
	 ...
	 * 获取 modRecCode
	 * 
	 * @return the modRecCode 待更正业务标识码 [1..1]
	 */
