...
// 访问类型改为字段
@XmlType(propOrder = { "PleNm", "PleInf" },namespace = "com.dhcc.xml.per.entity.motgacltalctrctinfo")
// 指定序列成的xml节点顺序
public class MotgaProptInfSgmt {
	...
	public List<PleInf> getPleInf() {
		return PleInf;
	}

	public void setPleInf(List<PleInf> pleInf) {
		PleInf = pleInf;
	}
