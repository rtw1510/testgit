 ...
 * 处理类。
 */
@Component("InIDEfctInfDltProcessor")
@StepScope
public class InIDEfctInfDltProcessor implements ItemProcessor<InIDEfctInfDlt, Object> {
	/** 生成报文名*/
	...
	public Object process(InIDEfctInfDlt inIDEfctInfDlt) throws Exception {
		PerDocument perDocument = new PerDocument();
		perDocument.setInIDEfctInfDlt(inIDEfctInfDlt);
